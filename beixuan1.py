...
### Google Mobility
    ...
    fig.add_trace(go.Scatter(x = df4.Date, y = df4.Retail,
                        name = 'Retail',
                        fill = 'tozeroy',
                        line = dict(width = 2,
                                    color = 'rgb(229, 151, 50)')),
    ...
    fig.add_trace(go.Scatter(x = df4.Date, y = df4.Grocery,
                        name = 'Grocery',
                        fill = 'tozeroy',
                        line = dict(width = 2,
                                    color = 'rgb(51, 218, 230)')),
    ...
    fig.add_trace(go.Scatter(x = df4.Date, y = df4.Parks,
                        name = 'Parks',
                        fill = 'tozeroy',
                        line = dict(width = 2,
                                    color = 'rgb(61, 202, 169)')),
    ...
    fig.add_trace(go.Scatter(x = df4.Date, y = df4.Transit,
                        name = 'Transit',
                        fill = 'tozeroy',
                        line = dict(width = 2,
                                    color = 'rgb(148, 147, 159)')),
    ...
    fig.add_trace(go.Scatter(x = df4.Date, y = df4.Work,
                        name = 'Work',
                        fill = 'tozeroy',
                        line = dict(width = 2,
                                    color = 'rgb(143, 132, 242)')),
    ...
    fig.add_trace(go.Scatter(x = df4.Date, y = df4.Residential,
                        name = 'Residential',
                        fill = 'tozeroy',
                        line = dict(width = 2,
                                    color = 'rgb(242, 132, 227)')),
    ...
    if (df3['State'][0] == "The Whole Country"):
        fig.update_layout(height=500, width=700, 
                    title = 'Time Series Plot for Mobility in ' + str(df4['County'][0]),
                    hovermode = 'closest')
        
        fig['layout'].update(shapes = [{'type': 'line', 'y0':0, 'y1': 0, 
                                       'x0':min(df4.Date), 'x1':max(df4.Date),
                                       'xref':'x1', 'yref':'y1',
                               'line': {'color': 'black', 'width': 0.5}
                               },
                               {'type': 'line', 'y0':0, 'y1': 0, 
        ...
        fig.update_layout(height=500, width=700, 
                        title = 'Time Series Plot for Mobility in ' + str(df4['County'][0]) + ', ' + str(df3['State'][0]),
                        hovermode = 'closest')
